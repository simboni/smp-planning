-- ===========================================================================
-- StackUp — Neon catch-up: file-subsystem repair + uploaded documents
-- (schema 0040 + 0041)
--
-- FIXES the "internal server error" on task file uploads (drifted schema)
-- and enables uploaded documents. Paste into the Neon SQL editor as the
-- OWNER role and Run. Idempotent — safe to run twice.
-- ===========================================================================
...
INSERT INTO schema_migrations (filename) VALUES
  ('0040_repair_files.sql'),
  ('0041_uploaded_docs.sql')
